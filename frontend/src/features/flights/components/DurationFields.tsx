...
export default function DurationFields({
  ...
  return (
    <div data-testid="duration-fields">
      <span className="mb-[7px] block text-[11.5px] text-[#9fb0c7]">مدت پرواز *</span>
      ...
      {total != null ? (
        <p className="mt-1.5 text-[11px] text-[#9fb0c7]" data-testid="duration-summary">
          {formatDurationFa(total)}
        </p>
      ) : invalid ? (
        <p role="alert" className="mt-1.5 text-[11px] font-semibold text-[#f87171]">
