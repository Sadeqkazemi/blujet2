...
> = {
  fa: {
    ...
    visualSub:
      'به شبکه B2B blujet بپیوند و از نرخ‌های عمده، قفل مقعد با اولویت و پشتیبانی اختصاصی آژانس بهره‌مند شو.',
    perks: ['نرخ عمده و خالص روی همه مسیرها', 'قفل مقعد با اولویت', 'کارشناس اختصاصی حساب B2B'],
    langLabel: 'FA',
  },
  en: {
