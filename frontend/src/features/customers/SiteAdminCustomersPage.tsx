...
type DetailTab = 'info' | 'purchases' | 'contacts' | 'club';
...
function CustomerDetailView({
  ...
  return (
    <div className="flex flex-col gap-[15px] px-[21px] pb-[34px] pt-[18px]">
      ...
      <div className="flex flex-wrap items-center gap-3.5 rounded-[14px] border border-[#1f2a3d] bg-[#141d2e] p-[18px]">
        ...
        <div className="min-w-0 flex-1 leading-relaxed">
          ...
          <div className="mt-[3px] text-[11.5px] text-[#9fb0c7]" dir="ltr">
            {detail.phone ? faDigits(detail.phone) : '—'} · {detail.email || '—'}
          </div>
        </div>
      ...
      <div className="flex w-fit flex-wrap gap-[3px] rounded-[11px] border border-[#1f2a3d] bg-[#0f1623] p-[3px]">
        {TABS.map((t) => {
      ...
      {tab === 'info' && (
        <>
          <div className="rounded-[14px] border border-[#1f2a3d] bg-[#141d2e] p-4">
            ...
            <div className="grid grid-cols-2 gap-x-5 gap-y-[15px]">
              <div>
                <div className="mb-[5px] text-[11px] text-[#6b7b94]">نام و نام خانوادگی</div>
                <div
                  className="text-[13px] font-bold"
                  style={{ color: detail.fullName.trim() ? '#fff' : '#f59e0b' }}
                >
                  {detail.fullName.trim() || 'ثبت نشده'}
                </div>
              </div>
              <div>
                <div className="mb-[5px] text-[11px] text-[#6b7b94]">کد ملی</div>
                <div
                  className="text-[13px] font-bold"
                  dir="ltr"
                  style={{ color: detail.nationalId ? '#fff' : '#f59e0b' }}
                >
                  {detail.nationalId ? faDigits(detail.nationalId) : 'ثبت نشده'}
                </div>
              </div>
              <div>
                <div className="mb-[5px] text-[11px] text-[#6b7b94]">موبایل</div>
                <div className="text-[13px] font-bold text-white" dir="ltr">
                  {detail.phone ? faDigits(detail.phone) : '—'}
                </div>
              </div>
              <div>
                <div className="mb-[5px] text-[11px] text-[#6b7b94]">ایمیل</div>
                <div className="text-[13px] font-bold text-white">{detail.email || '—'}</div>
              </div>
              <div>
                <div className="mb-[5px] text-[11px] text-[#6b7b94]">تاریخ ثبت‌نام</div>
                <div className="text-[13px] font-bold text-white">
                  {formatJalaliDate(detail.registeredAt)}
                </div>
              </div>
            </div>
          </div>
