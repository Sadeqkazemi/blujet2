...
- [ ] Phase 9 — Reservation system (seat lock/PNR) — **done/assigned outside this track per the user (2026-07-17); this track must NOT implement it.** Reconcile via docs/API.md + DB_SCHEMA.md before either side touches shared tables (Booking/FlightInstance/seat inventory); the `role === 'super'` mapping decision belongs to that track.
