...
import type { AircraftSeatMap } from '../../../generated/typeorm/client';
...
export class PassengerReportsService {
  ...
  async search(q: string) {
    ...
    const passengers = await this.typeorm.passenger.findMany({
      where: isNationalId
    ...
    const seatMaps = await this.typeorm.aircraftSeatMap.findMany({
