...
- [x] One journey per role: open آژانس‌ها → search → open an agency → change credit limit → see it reflected — `'agencies journey for <senior|finance.karimi|comm.abbasi>: search, open detail, change credit limit'` (3 tests)
